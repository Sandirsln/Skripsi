...
// Pastikan nama file header di bawah ini sesuai dengan file kuantisasi Kasus A Anda
...
float input_scale = 1.958823561668396f;
int8_t input_zero_point = -1;
float output_scale = 3.9176385402679443f;
...
void setup() {
    ...
    Serial.println("--- Continuous Quantized Inference Started (Case A) ---");
...
void loop() {
    ...
    for (int i = 0; i < TEST_SAMPLES_COUNT_A; i++) {
        ...
        // 1. KUANTISASI: Ubah input float ke int8 sebelum inferensi
